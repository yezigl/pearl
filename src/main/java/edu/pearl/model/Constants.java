...
public class Constants {
    ...
    public static final String WX_API_ACCESSTOKEN = WX_HOST + "/token";
    
    public static final String WX_API_MENUCREATE = WX_HOST + "/menu/create";
    
    public static final String WX_API_MENUDELETE = WX_HOST + "/menu/delete";
    
    public static final String WX_API_QRCODE = WX_HOST + "/qrcode/create";
